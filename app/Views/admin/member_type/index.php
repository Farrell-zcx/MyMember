                                    ...
                                    <?php foreach ($members as $m): ?>
                                        <tr class="hover:bg-surface-container-low transition-all">
                                            ...
                                            <td class="py-3.5 px-4 text-center space-x-1 whitespace-nowrap">
                                                ...
                                                <a href="/admin/member-type?delete=<?= esc($m['NIK']) ?>" onclick="return confirm('Yakin hapus member dengan NIK ini, bree?')" class="bg-rose-100 hover:bg-rose-200 text-rose-800 font-bold px-2.5 py-1.5 rounded-md transition-all">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
