                ...
                <form action="/register/process" class="space-y-lg" method="POST">
                    ...
                    <div class="space-y-xs">
                        ...
                        <div class="relative group">
                            ...
                            <input class="w-full h-[52px] pl-[48px] pr-md glass-input rounded-lg font-body-md text-body-md focus:outline-none transition-all outline-none" id="nama_resepsionis" name="nama_resepsionis" placeholder="Nama Lengkap" required="" type="text" autocomplete="off" />
                        </div>
                    </div>
